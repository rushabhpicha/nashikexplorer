...
public class autofare_night extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(getActivity(), R.layout.listview_for_picnicplaces, R.id.textView_picnic
                ,data);

...
/**
 * Created by Picha on 7/19/2017.
 */

public class Function {
    private static final String OPEN_WEATHER_MAP_URL =
            "http://api.openweathermap.org/data/2.5/weather?lat=19.997454&lon=73.789803";

    private static final String OPEN_WEATHER_MAP_API = "cf6322bcb6656b53069548023f235bf4";
        ...
        protected void onPostExecute(JSONObject json) {
            try {
                if(json != null){
                    ...
                    String temperature = String.format("%.2f", main.getDouble("temp")-273)+ "°C";
